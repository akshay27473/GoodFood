...
public class Elevenimg extends AppCompatActivity {
    Button button;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_elevenimg);
        button=findViewById(R.id.elevenorder);
    }
    public  void onClick(View view){
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Elevenimg.this, "Thank for yor Ordering!!", Toast.LENGTH_SHORT).show();
