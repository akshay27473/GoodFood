...
public class Twelveimg extends AppCompatActivity {
    Button button;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_twelveimg);
        button=findViewById(R.id.twelveorder);
    }
    public  void onClick(View view){
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Twelveimg.this, "Thank for yor Ordering!!", Toast.LENGTH_SHORT).show();
