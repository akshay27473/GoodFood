...
public class Thirteenimg extends AppCompatActivity {
    Button button;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thirteenimg);
        button=findViewById(R.id.thirteenorder);
    }
    public  void onClick(View view){
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Thirteenimg.this, "Thank for yor Ordering!!", Toast.LENGTH_SHORT).show();
