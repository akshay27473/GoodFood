...
public class Secondimg extends AppCompatActivity {
Button button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_secondimg);
        button = findViewById(R.id.secondorder);
    }
    public  void onClick(View view){
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Secondimg.this, "Thank for yor Ordering!!", Toast.LENGTH_SHORT).show();
